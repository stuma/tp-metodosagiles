...
public class ConexionDB {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/tp-metodosagiles?useSSL=false";
    private static final String user = "root";
    private static final String pass = "";

    private static boolean _TABLAS_CREADAS = false;

    //TODO definir query para crear las tablas de la db correspondientes
